          ...
          return (
            ...
            >
              <div className='flex justify-between items-center mb-[15px] px-[30px]'>
                ...
                <span
                  className="text-titleColor dark:text-titleColorDark font-[700] text-large "
                  style={{ whiteSpace: "nowrap" }}
                >
                  {percentage} <span className="text-primaryColor">%</span>
                </span>
              </div>
              <p className='px-[30px] text-titleColor dark:text-titleColorDark text-small'>
                {description}
              </p>

              <div className='mb-[10px] mt-[30px]  h-[2px] dark:bg-[rgba(255,255,255,0.2)] bg-[rgba(0,0,0,0.3)] mx-12 sm:mx-4'
              style={{
